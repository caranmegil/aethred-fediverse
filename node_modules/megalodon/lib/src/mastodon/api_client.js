...
var stream_listener_1 = __importDefault(require("./stream_listener"));
...
(function (MastodonAPI) {
    var Client = (function () {
        ...
        Client.prototype.stream = function (path, reconnectInterval) {
            ...
            var url = this.baseUrl + path + ("?access_token=" + this.accessToken);
            var streaming = new stream_listener_1.default(url, headers, this.proxyConfig, reconnectInterval);
